...
## Además, se realizaron pruebas de los endpoints utilizando Swagger UI y Thunder Client como alternativa a Postman. Con Swagger se validó el correcto funcionamiento de cada operación del API, permitiendo visualizar y ejecutar las rutas de manera interactiva. Thunder Client fue utilizado para enviar solicitudes, revisar respuestas del servidor, y asegurar que los métodos de creación, consulta, actualización y eliminación funcionaran correctamente. Estas pruebas permitieron verificar el correcto funcionamiento del sistema y corroboran que la lógica implementada opera adecuadamente bajo diferentes escenarios.
